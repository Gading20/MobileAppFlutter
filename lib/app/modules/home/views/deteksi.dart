...
class _AudioClassifierHomePageState extends State<AudioClassifierHomePage>
  ...
  Future<void> _uploadFile(File file) async {
    ...
    try {
      var request = http.MultipartRequest(
          'POST',
          Uri.parse(
              'http://172.20.10.4:5000/predict')); // Ensure this IP is correct
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 5.0, vertical: 60.0),
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Colors.indigo, Colors.white], // Background colors
